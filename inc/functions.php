...
function colormag_footer_copyright() {
   ...
   $default_footer_value = sprintf( __( '%2$s. %1$s.', 'colormag' ), date( 'Y' ), $site_link ).'<br>'.sprintf( __( 'Creado por futroninos para el mundo :)', 'colormag' ), 'ColorMag', $tg_link ).' . '.sprintf( __( '' ));
